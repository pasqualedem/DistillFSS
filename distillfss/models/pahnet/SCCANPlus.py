...
from .PAHNet_transformer import SwinTransformer
from .loss import WeightedDiceLoss
from .PSPNet import OneModel as PSPNet
from einops import rearrange
from .SSP_matching import SSP_MatchingNet as SSP_matching
...
class OneModel(nn.Module):
    def __init__(self, args):
        ...
        PSPNet_ = PSPNet(args)
        pre_weight = 'checkpoints/bam/PSPNet/{}/split{}/{}/best.pth'.format(self.dataset, args.split, "resnet50" if not args.vgg else "vgg")
        print(pre_weight)
        ...
        ssp_weight = "checkpoints/SSPNet/{}/split{}/{}/best.pth".format(self.dataset, args.split, "resnet50" if not args.vgg else "vgg")
